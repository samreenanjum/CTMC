...
class CLEAR(_BaseMetric):
    ...
    def eval_sequence(self, data):
        ...
        #print("len of : {}".format(len(data['gt_ids'])))
        #print("total length : {}".format(num_timesteps))
        #print("det example: {}".format((data['gt_dets'][0])))
        #print("gt id example: {}".format((data['gt_ids'][0])))

        # Calculate scores for each timestep
        for t, (gt_ids_t, tracker_ids_t) in enumerate(zip(data['gt_ids'], data['tracker_ids'])):
            #print('dets: t = {}, gt = {}, trakers = {}'.format(t, gt_ids_t, tracker_ids_t))
