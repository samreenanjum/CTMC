...
if __name__ == '__main__':
    ...
    default_dataset_config = hm.datasets.CTMC2DBox.get_default_dataset_config()
    default_metrics_config = {'METRICS': ['HOTA', 'CLEAR', 'Identity', 'TRA']}
    ...
    dataset_list = [hm.datasets.CTMC2DBox(dataset_config)]
    metrics_list = []
    for metric in [hm.metrics.HOTA, hm.metrics.CLEAR, hm.metrics.Identity, hm.metrics.TRA]:
